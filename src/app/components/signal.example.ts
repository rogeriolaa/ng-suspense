...
@Component({
  ...
  template: `
    <h2 class="text-xl font-semibold text-gray-700 mb-4">Signal Example</h2>
    <p class="text-gray-600 mb-4">
      Fetches posts using 'toSignal()' to convert an **Observable** into a
      **Signal**.
    </p>
...
export class SignalExample {
  ...
  posts = toSignal(this.api.getPostsForSignal());
  constructor() {}
}
