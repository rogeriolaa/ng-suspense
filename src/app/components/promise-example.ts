...
@Component({
  ...
  template: `
    <h2 class="text-xl font-semibold text-gray-700 mb-4">Promise Example</h2>
    <p class="text-gray-600 mb-4">
      Fetches posts from an API using a **Promise** with a 2-second delay.
    </p>
...
export class PromiseExample {
  ...
  postsPromise = this.api.getPostsAsPromise();
}
